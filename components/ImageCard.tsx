...
export default function ImageCard({
  ...
  // Pinterest Pin Creator URL
  const siteUrl = 'https://pinterest-gallery.vercel.app'
  const descriptionWithProfile =
    `${title} - ${description} | Follow me on Pinterest: https://in.pinterest.com/sanyamaethere/`
  ...
  return (
    ...
    >
      <div
        ref={imgRef}
        className="group relative overflow-hidden rounded-lg bg-gray-100 cursor-pointer shadow-md hover:shadow-xl transition-all duration-300"
        style={{
      ...
      >
        ...
        {/* Pinterest Badge */}
        <div className="absolute top-3 right-3 bg-[#E60023] text-white p-2 rounded-full shadow-lg opacity-90 group-hover:scale-110 transition">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition">
          <div className="absolute bottom-0 p-4 text-white">
            ...
            <div className="mt-2 bg-[#E60023] px-3 py-2 rounded-full text-sm w-fit">
              Save to Pinterest
            </div>
          </div>
        </div>
